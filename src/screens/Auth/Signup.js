        ...
        <Grid className='container'>
            <form className='form'>
                ...
                <Grid style={{ display: 'flex', flexDirection: 'column' }}>
                    <Grid>
                        <label for="terms" style={{ color: ' black', padding: '10px', float: 'left', fontSize: 'smaller' }}>This Id is already exist <Link href='/login' style={{ textDecoration: 'none' }}>Login</Link></label>
                    </Grid>
                    <Grid>
